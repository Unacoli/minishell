...
#    Updated: 2022/07/09 17:41:56 by ldubuche         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES	= main.c start_shell.c cd.c echo.c env.c exit.c export.c pwd.c unset.c\
			utils.c default_env.c environnement.c built_in.c execve.c\
			...
			signal_handler.c double_lexer.c less_great.c handle_quote_substi.c\
